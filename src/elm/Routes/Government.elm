    ...
    div [ class "pa1" ]
        ...
        , div [ class "ml3 mt3 mb3" ]
            [ input [ id "yes", name "yesno", type_ "radio", value "yes", class "dn" ]
                []
            , label [ for "yes", class "bg-white pa3 pl4 pr4  pointer ba b--mid-gray mw4 br--left br1 tc" ]
                [ text "Yes " ]
            , input [ id "no", name "yesno", type_ "radio", value "no", class "dn" ]
                []
            , label [ for "no", class "bg-white pa3 pl4 pr4 tc pointer br bt bb b--mid-gray mw4 br--right br1" ]
                [ text "No " ]
            ]
