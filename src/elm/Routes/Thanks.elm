...
thanks model =
    div [ class "pa1" ]
        ...
        , div [ class "flex flex-wrap justify-center items-center" ]
            [ div [ class "bg-light-teal white pa3 ma2 w-40 tc br1" ] [ text "Sign up to newsletter?" ]
            , div [ class "bg-light-teal white pa3 ma2 w-40 tc br1" ] [ text "Join our AVA network" ]
            , div [ class "bg-light-teal white pa3 ma2 w-40 tc br1" ] [ text "Get in touch with us" ]
            , div [ class "bg-light-teal white pa3 ma2 w-40 tc br1" ] [ text "Do you need support?" ]
            ]
        ]
